...
<div style="float:none;"><div class="right-list" style="float:left;margin-top:8px;">SUBSCRIBE</div><div  style="float:right;"><input class="right-subscribe" type="text" name="subscribe-right" id="subscribe-right" placeholder="Enter your email here">
