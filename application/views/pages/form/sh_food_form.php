        ...
        <div id="left-container">
        	<div id="form_wrapper" style="font-family:'karla'; width:630px!important;">
                ...
                <div id="form_sub_header">
                	ST KILDA FESTIVAL 2013: STALLHOLDERS – FOOD
                </div>
                ...
                <div style="line-height:15px;">
                    ...
                    In 2013, the big day falls on Sunday, 10th of February. With a usual crowd of approximately 300,000 we expect that we will have many hungry mouths to feed!<br/><br/>
...
E: <a href="mailto:skftraders@portphillip.vic.gov.au">skftraders@portphillip.vic.gov.au</a><br/><br/>
				...
				?>
                    ...
                    <div class="gap"></div>
                    <div style="line-height:15px;">
                        Storage capacity for cool rooms is extremely limited. Cool room sites are subject to availability and charged at a flat rate of $110.00 per cool room site. Sites allocated are at the discretion of St Kilda Festival Management.
                    </div>
                    ...
                    <div>
                        ...
                        <div style="float:left">
                        	<select class="form_input" name="power_required_coolroom">
                                <option value="1 x 15 amp outlet - $110.00">1 x 15 amp outlet - $110.00</option>
                                <option value="2 x 15 amp outlet - $220.00">2 x 15 amp outlet - $220.00</option>
                                <option value="3 x 15 amp outlet - $330.00">3 x 15 amp outlet - $330</option>
                                <option value="1 x 3 phase outlet(32 amp, 5 pin, 3 phase) - $418.00" />1 x 3 phase outlet(32 amp, 5 pin, 3 phase) - $418.00</option>
                                <option value="I do not require power $0" />I do not require power $0</option>
                            </select>
                        </div>
                    ...
                    <div>
                        <div class="form_label" style="float:left; width:50px;">
                        	<input type="radio" class="validate['required']" id="hr1" name="health_registration" value="Option 1:Class 2 & 3 Traders: I have registered a Temporary or Mobile Food Premises with my Principal Council and I have enclosed a copy of the Registration Certificate." />
                        </div>
                        <div style="float:left; width:550px;">Option 1:Class 2 & 3 Traders: I have registered a Temporary or Mobile Food Premises with my Principal Council and I have enclosed a copy of the Registration Certificate.</div>    
                    </div>
                    <div class="gap"></div>
                    ...
                    <div>
                        <div class="form_label" style="float:left; width:50px;">
                        	<input type="radio" class="validate['required']" id="hr2" name="health_registration" value="Option 2:Class 4 Traders: I have lodged a Notification Form with my Principal Council (copy enclosed)." />
                        </div>
                        <div style="float:left; width:550px">Option 2:Class 4 Traders: I have lodged a Notification Form with my Principal Council (copy enclosed).</div>    
                    </div>
                    <div class="gap"></div>
                    ...
                    <div class="gap"></div>
                    <div style="line-height:15px;">
                        For further information on Temporary Food Premises Permit Information for Mobile Food Vehicles & Temporary Stalls can be downloaded <a href="<?=base_url()?>uploads/Doc39.pdf" target="_blank">here</a>
                    </div>
                    <div class="gap"></div>
                    ...
                    <div>
                        ...
                        <div style="width:auto; float:left">$110.00</div>
                    </div>
                    <div class="gap"></div>
                    <div>
                    ...
                    <div>
                        ...
                        <div style="width:auto; float:left">$110.00 per outlet<br />$418.00 per outlet</div>
                    </div>
                    <div class="gap"></div>
                    <hr />
                    <div class="gap"></div>
                    ...
                    <div class="gap"></div>
                    <div style="line-height:15px;">
                        Total revenue/sales figures for trade on the day of the event must be detailed on the <a href="<?=base_url()?>uploads/Doc40.pdf" target="_blank">Trader Revenue Declaration form</a> and submitted by close of business on Wednesday 13th February 2013. Please submit this information by fax or email as per details below.
                    </div>
                    <div class="gap"></div>
                    <div style="line-height:15px;">
                    ...
                    - <a href="<?=base_url()?>uploads/Doc34.pdf" target="_blank">General Information: Download Here</a> <br /><br/>
                    - <a href="<?=base_url()?>uploads/Doc37.pdf" target="_blank">General Conditions: Download Here</a><br/><br/>
                    - <a href="<?=base_url()?>uploads/Doc36.pdf" target="_blank">Food Trader Checklist: Download here</a><br/><br/>
