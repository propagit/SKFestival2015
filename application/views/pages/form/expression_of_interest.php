                ...
                <form action="<?=base_url()?>page/add_expression_of_interest" method="post" onsubmit="return validate_form();">
                    <div id="form_content">
                    	<div style="font-family:karla; font-size:12px;">
                        	Would you like to be considered to have a stall at Yalukit Willam Ngargee or Festival Sunday or Both? *
                        </div>
                        <div class="gap"></div>
                        <div>
                            ...
                            <div style="font-family:karla; font-size:12px;float:left">Yalukit Willam Ngargee</div>
                        </div>
                        <div class="gap"></div>
                        <div>
                        ...
                        <div>
                            ...
                            <div style="font-family:karla; font-size:12px;float:left">Yalukit Willam Ngargee & Festival Sunday</div>
                        </div>
                        <div class="gap"></div>
                    	<div>
                        ...
                        <div class="gap"></div>
                        <div>
                        	Have you had a stall at Yalukit Willam Ngargee or St Kilda Festival before?*
                        </div>
                        <div class="gap"></div>
                        <div>
