        ...
        <div id="left-container">
        	<div id="form_wrapper" style="font-family:'karla'">
                ...
                <div id="form_sub_header">
                	ST KILDA FESTIVAL 2013: STALLHOLDERS - MARKET
                </div>
                
                <div style="line-height:15px;">
                	<span class="subheading2_content_page">APPLICATION FOR AN ITINERANT MARKET TRADER</span><br/><br/>
                    We are calling for market stallholders who are exuberant, unique and sell lots of shiny, pretty things to complement local retailers and join our Festival Sunday celebrations!<br/><br/>
                    In 2013, the big day falls on Sunday, 10th of February. With a usual crowd of approximately 300,000 we&rsquo;re expecting many inquisitive punters who will be keen to explore what the day has to offer!<br/><br/>
				...
				?>
                    ...
                    <div>
                        <div class="form_label" style="float:left">
                        	Please attach a photo of your stall here *<br />(Photo must be 1Mb or less in size)
                        </div>
                        <script>
                    ...
                    <div style="clear:both; height:10px;"></div>
                    <div style="line-height:15px;">
                        Please note that site all locations are at the absolute discretion of St Kilda Festival Management. The zone requested is not guaranteed. Corner sites are extremely limited and attract a surcharge of $55.00. Due to limited availability, in fairness to all approved participants, a stallholder can apply to be considered for a single corner location only.<br/></br/>
                        I wish to be located in a:<br/>
                        <input type="checkbox" name="stall_location[]" value="Pedestrian Flow Zone - $290.00 per Standard Site" /> Pedestrian Flow Zone - $290.00 per Standard Site<br/>
                        <input type="checkbox" name="stall_location[]" value="Regular Zone - $150.00 per Standard Site" /> Regular Zone - $150.00 per Standard Site<br/><br/>
                    ...
                    <div>
                        <div class="form_label" style="float:left; width:50px;">
                        	<input type="checkbox" name="hire_package[]" value="3x3m Marquee Package - $245.00 (Includes 3x3 Marquee, 2 chairs, 1 x 8' trestle table)" />
                        </div>
                        <div style="float:left">3x3m Marquee Package - $250.00 includes 3x3 Marquee, 2 chairs, 1 x 8' trestle table</div>    
                    </div>
                    <div style="clear:both; height:10px;"></div>
                    <div>
                        <div class="form_label" style="float:left; width:50px;">
                        	<input type="checkbox" name="hire_package[]" value="6x3m Marquee Package - $470.00 (Includes 6x3 Marquee, 2 chairs, 2 x 8' trestle table)" />
                        </div>
                        <div style="float:left">6x3m Marquee Package - $475.00 includes 6x3 Marquee, 2 chairs, 2 x 8' trestle table</div>    
                    </div>
                    <div style="clear:both; height:10px;"></div>
                    <div>
                        <div class="form_label" style="float:left; width:50px;">
                    ...
                    <div>
                        ...
                        <div style="float:left">
                        	<select class="form_input" name="power_option">
                                <option value="1 x 15 amp outlet - $110.00">1 x 15 amp outlet - $110.00</option>
                                <option value="2 x 15 amp outlet - $220.00">2 x 15 amp outlet - $220.00</option>
                                <option value="3 x 15 amp outlet - $330.00">3 x 15 amp outlet - $330.00</option>
                                <option value="1 x 3 phase outlet (32 amp, 5 pin, 3 phase) - $418.00" />1 x 3 phase outlet (32 amp, 5 pin, 3 phase) - $418.00</option>
                    ...
                    <div>
                        ...
                        <div style="width:auto; float:left">$27.50</div>
                    </div>
                    <div style="clear:both; height:10px;"></div>
                    <div>
                        ...
                        <div style="width:auto; float:left">$290.00<br />$150.00</div>
                    </div>
                    <div style="clear:both; height:10px;"></div>
                    <div>
                        <div style="width:400px; float:left">Corner Site Fee (GST not applicable)</div>
                        <div style="width:auto; float:left">$55.00</div>
                    </div>
                    <div style="clear:both; height:10px;"></div>
                    <div>
                        ...
                        <div style="width:auto; float:left">$250.00<br />$475.00</div>
                    </div>
                    <div style="clear:both; height:10px;"></div>
                    <div>
                        <div style="width:260px; float:left">Power (GST inclusive)</div>
                        <div style="width:140px; float:left">15 amp outlet</div>
                        <div style="width:auto; float:left">$110.00 per outlet</div>
                    </div>
                    <div style="clear:both; height:10px;"></div>
                    <div style="line-height:15px;">
                    ...
                    <div style="line-height:15px;">
                        ...
                        <br/>
                    - <a href="<?=base_url()?>uploads/Doc27.pdf" target="_blank">General Conditions: Download Here</a><br/><br/>    
                    - <a href="<?=base_url()?>uploads/Doc24.pdf" target="_blank">General Information - Market Stall: Download Here</a> <br /><br/>
                    - <a href="<?=base_url()?>uploads/Doc26.pdf" target="_blank">Market Trader Checklist: Download here</a><br/><br/>
                    ...
                    <div style="line-height:15px;">
                        ...
                        This information must be provided by <b>TUESDAY, 04th DECEMBER 2012</b> or your application may not be considered. Your documentation can be forwarded by the following methods:<br/><br/>
                        By post:<br/>
                        Angela de Mel<br />
                        Trader Liaison<br />
                        St Kilda Festival<br />
