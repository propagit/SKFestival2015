...
day = new Date();
id = day.getTime();
URL = '<?=base_url()?>admin/cms/page/band/' + page_id;
...
.quick-func { height:36px; float:right; width:80px; text-align:center; border-left:1px dotted #63A2D4; }
 ...
 <div id="left-content">
    ...
    <div class="bar-title"><div>Manage Page</div></div>    
            ...
            <div class="box2">
                ...
                -->
                <div class="row-title">
                    <div class="cat-name" >Title Page (ID)</div>    
                                  
                    <div class="quick-func">Delete</div>
                    <div class="quick-func">Content</div>
                    <div class="quick-func">Bands</div>  
                </div>
                <div id="subcat">
                    <?php foreach($pages as $page) { ?>
                    <div class="row-item">
                        <div class="cat-name" ><a href="<?=base_url()?>page/pages/<?=$page['id']?>" target="_blank" ><?=$page['title']?> (<?=$page['id']?>)</a></div>
                        ...
                        <div class="quick-func"><a href="javascript:film(<?php echo $page['id']?>)"><img src="<?php echo base_url()?>images/admin/film.png" /></a></div> 
                     </div>
                    <?php } ?>
                </div>
            </div>
