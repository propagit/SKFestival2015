...
<div id="left-content">
    ...
    <div class="content-area">
		...
		<div id="gallery">
            <ul>
                <li>
                    <a title="<?=$photo['caption']?>" href="<?=base_url()?>uploads/galleries/<?php print md5("cdkgallery".$gallery['id']); ?>/<?=$src?>">
                        <img title="<?=$photo['title']?>" src="<?=base_url()?>uploads/galleries/<?php print md5("cdkgallery".$gallery['id']); ?>/thumbnails/<?=$src?>" alt="" />
                    </a>
                </li>
            </ul>
        </div>
        ...
        <input type="hidden" name="gallery_id" value="<?=$gallery['id']?>" />
         <table cellpadding="0" cellspacing="0" border="0">
           <tr><td>Photo Image Title</td>
               <td width="20">
               <td><input type="text" name="title" class="medium" value="<?=$photo['title']?>" /></td>
           </td>
         </tr>
         <tr height="10"><td>&nbsp;</td></tr>
         <tr><td>Photo Image Caption</td>
               <td width="20">
               <td><input type="text" name="caption" class="medium" value="<?=$photo['caption']?>" /></td>
           </td>
         </tr>
        </table>
        <br/>
        <a href="#"><input type="button" class="button rounded" value="Update" onClick="document.addPhotoTitleForm.submit()" /></a>
        </form>
        </div>
