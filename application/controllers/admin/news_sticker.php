...
class News_sticker extends CI_Controller {
	...
	{
		$id = $_POST['id'];
		$news = $this->News_sticker_model->id($id);
		if($this->News_sticker_model->delete($id))
		{
			unlink("/home/stkildaf/public_html/2013/photos/news_sticker/".$news['image']);
			unlink("/home/stkildaf/public_html/2013/photos/news_sticker/thumbnails/".$news['image']);	
		}
	}
}
?>