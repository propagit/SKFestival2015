...
class Csv extends CI_Controller {
	...
	function musicians_to_csv()
	{
		...
		$header = "id,Band Name,Music Type,Contact Name,Phone,Alt Phone,Email,Track1,Track2,Receive Email,Live Work Study,Band Member Name,Role,Suburb Live Work Study,Mailing Address,Band Details,Band Online,Play Push Stage,Willing To Play,Equipment,Previous,Fee Exempt,Payment Method,Contact Email,Billing Name,Billing Address,Payment Number\r\n";  
		$csv_output = '';
