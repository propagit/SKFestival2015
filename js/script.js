...
{
    $("#band-wrapper div[title]").tooltip({effect: 'fade',
   ...
   //$("#band-wrapper img").tooltip();
	...
	//create title
	//createList('2014 MUSIC LINE UP',v);
	//create view-all
	...
	$('#filterAll a').on('click',function(e){
		var link = $(this);
	...
	function createList(text,items){
		...
		if(text == 'Sat 02 Feb') {text = 'Sat 02'}
		if(text == 'Sun 03 Feb') {text = 'Sun 03'}
		if(text == 'Mon 04 Feb') {text = 'Mon 04'}
		if(text == 'Tue 05 Feb') {text = 'Tue 05'}
		if(text == 'Wed 06 Feb') {text = 'Wed 06'}
		if(text == 'Thu 07 Feb') {text = 'Thu 07'}
		if(text == 'Fri 08 Feb') {text = 'Fri 08'}
		if(text == 'Sat 09 Feb') {text = 'Sat 09'}
		if(text == 'Sun 10 Feb') {text = 'Sun 10'}
